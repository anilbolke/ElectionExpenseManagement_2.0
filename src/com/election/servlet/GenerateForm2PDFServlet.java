...
import com.election.util.PDFGeneratorExpenseReport;

public class GenerateForm2PDFServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Generate Form 2 Expense Report (HTML format with नमुना-२ header)
            byte[] pdfData = PDFGeneratorExpenseReport.generateExpenseReport(candidate);
