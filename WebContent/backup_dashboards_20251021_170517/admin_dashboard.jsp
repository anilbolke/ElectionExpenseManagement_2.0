...
<head>
    ...
    <title>Admin Dashboard - Election Expense</title>
    ...
    <nav class="navbar">
        <div class="navbar-content">
            ...
            <ul class="navbar-menu">
                ...
                <li><a href="manage-payments.jsp">Payment Activity</a></li>
            </ul>
            <div class="user-info">
        ...
        <div class="dashboard-grid">
            ...
            <div class="sidebar">
                ...
                <div class="quick-actions-compact">
                    <h3>⚡ Quick Actions</h3>
                    <a href="view-users.jsp" class="action-btn">👥 View Users</a>
                    <a href="view-candidates.jsp" class="action-btn secondary">🗳️ View Candidates</a>
                    <a href="view-brokers.jsp" class="action-btn tertiary">🤝 View Brokers</a>
                    <a href="register-broker.jsp" class="action-btn" style="background: #ed8936;">➕ Register Broker</a>
                    <a href="manage-payments.jsp" class="action-btn" style="background: #4299e1;">💳 Payment Activity</a>
                </div>
            ...
            <div class="main-content">
                ...
                <div class="alert alert-info">
                    ℹ️ <strong>Read-Only Access:</strong> As an admin, you have view-only access to all system data.
                </div>
                ...
                <div style="margin-bottom: 15px;">
                    <h3 style="font-size: 14px; font-weight: 600; margin-bottom: 10px;">💳 Payment Status Overview</h3>
                    <table>
                        <tr>
                ...
                <div>
                    <div class="content-header" style="border-bottom: none;">
                        ...
                        <a href="view-users.jsp" class="btn btn-primary btn-sm">View All →</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <% } else if ("broker".equals(u.getUserRole())) { %>
                                                <span class="badge badge-warning">Broker</span>
                                            <% } else { %>
