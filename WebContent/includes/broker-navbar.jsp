...
<nav class="multilang-navbar">
    <div class="multilang-navbar-content">
        ...
        <ul class="multilang-navbar-menu">
            <li><a href="<%= request.getContextPath() %>/broker/dashboard.jsp" 
                   class="<%= currentPage.contains("dashboard") ? "active" : "" %>">
                <%= MessageBundle.getMessage(request, "nav.dashboard") %>
            </a></li>
            <li><a href="<%= request.getContextPath() %>/broker/my-users.jsp"
                   class="<%= currentPage.contains("my-users") ? "active" : "" %>">
                <%= MessageBundle.getMessage(request, "broker.users") %>
            </a></li>
            <li><a href="<%= request.getContextPath() %>/broker/my-candidates.jsp"
                   class="<%= currentPage.contains("my-candidates") ? "active" : "" %>">
                <%= MessageBundle.getMessage(request, "broker.candidates") %>
            </a></li>
            <li><a href="<%= request.getContextPath() %>/broker/candidates.jsp"
                   class="<%= currentPage.contains("/candidates.jsp") ? "active" : "" %>">
                <%= MessageBundle.getMessage(request, "broker.all.candidates") %>
            </a></li>
            <li><a href="<%= request.getContextPath() %>/broker/transactions.jsp"
